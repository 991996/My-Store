                ...
                <TableRow>
                  <TableCell>
                    <div className=" relative">
                      <div className=" cursor-pointer absolute -top-2 right-7 p-1 bg-white rounded-full shadow aspect-square">
                        <X size={15} />
                      </div>
                      <Link to="/product-details" state={{ product: p }}>
                        <div className="w-20 aspect-square p-2 bg-gray-100">
                          <img
                            src={p.image}
                            alt="product image"
                  ...
                  <TableCell className=" font-thin">{p.title}</TableCell>
                  <TableCell className="text-gray-500">${p.price}</TableCell>
                  ...
                  <TableCell>
                    <div className="flex gap-2">
                      <Button
                        ...
                        className="uppercase cursor-pointer tracking-wider rounded-none py-5 text-[13px]
